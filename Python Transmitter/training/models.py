...
class FCMNIST(nn.Module):
    ...
    """
    def __init__(self,network_width1=64,network_width2=64,network_width3=64, image_res = 16, QuantType='Binary',WScale='PerTensor',NormType='RMS', quantscale=0.25):
        ...
        self.fc1 = BitLinear(1* 1 *image_res *image_res, network_width1,QuantType=QuantType,NormType=NormType, WScale=WScale, quantscale=quantscale)
