...
class BitQuant:
    ...
    def activation_quant(self, x):
        ...
        Scales everything to signed 8 bit value limits (-128 to 127).
        """
...
class BitLinear(nn.Linear, BitQuant):
    ...
    """
    def __init__(self, in_features, out_features, QuantType='Binary', WScale='PerTensor', NormType='RMS', quantscale=0.25):
